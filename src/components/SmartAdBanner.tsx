...
export const SmartAdBanner: React.FC<SmartAdBannerProps> = ({
  ...
  const getPricingBadge = () => {
    switch (campaign.pricingModel) {
      ...
      case 'cpc':
        return { label: 'درع النقرات الذكي (CPC Shield)', color: 'bg-purple-500/10 text-purple-400 border-purple-500/20' };
      default:
        return { label: 'إعلان موثوق', color: 'bg-purple-500/10 text-purple-400 border-purple-500/20' };
    }
  };
  ...
  return (
    <div
      ...
      className="relative my-6 rounded-2xl overflow-hidden border border-purple-500/20 bg-gradient-to-r from-slate-900 via-purple-950/40 to-slate-900 p-4 shadow-xl transition-all hover:border-purple-500/40"
    >
      {/* Top Header Badge */}
      <div className="flex flex-wrap items-center justify-between gap-2 mb-3 pb-2.5 border-b border-purple-500/15">
        <div className="flex items-center gap-2">
          <span className="text-[11px] font-bold px-2 py-0.5 rounded-full bg-purple-600/30 text-purple-300 border border-purple-500/30 flex items-center gap-1">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        {campaign.imageUrl && (
          <div className="relative w-full sm:w-44 h-28 rounded-xl overflow-hidden flex-shrink-0 bg-slate-800 border border-purple-500/10 group">
            <img
        ...
        <div className="flex-1 min-w-0 text-right w-full">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white text-xs font-bold shadow-lg shadow-purple-600/30 active:scale-95 transition-all"
            >
      ...
      {showInspector && (
        <div className="mt-4 pt-3 border-t border-purple-500/15 bg-purple-950/20 rounded-xl p-3 text-xs space-y-2 font-mono">
