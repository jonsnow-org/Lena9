        ...
        <article className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-5 sm:p-8">
          {section === 'privacy' && (
            <>
              ...
              <P>
                تعتمد المنصة على شبكات إعلانية تابعة لجوجل. قد تستخدم جوجل ملفات تعريف ارتباط
                لعرض إعلانات مبنية على زياراتك السابقة لهذا الموقع أو مواقع أخرى. يمكنك إلغاء
                الاشتراك في الإعلانات المخصصة من إعدادات إعلانات جوجل.
              </P>
              <P>
