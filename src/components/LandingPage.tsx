  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-purple-500 selection:text-white font-sans antialiased overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-10%] start-[20%] w-[600px] h-[600px] bg-purple-600/15 rounded-full blur-[140px]" />
        <div className="absolute top-[30%] end-[-5%] w-[500px] h-[500px] bg-indigo-600/15 rounded-full blur-[140px]" />
      ...
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-slate-950/80 border-b border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-gradient-to-tr from-purple-600 via-indigo-600 to-teal-400 p-0.5 shadow-lg shadow-purple-500/20">
              <div className="w-full h-full bg-slate-950 rounded-[14px] flex items-center justify-center">
                <span className="font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-teal-300 text-lg sm:text-xl tracking-wider">
                  L
                </span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {isUserLoggedIn && currentUser ? (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-extrabold text-xs shadow-md active:scale-95 transition-all"
              >
                <img
              ...
              <>
                ...
                <button
                  onClick={onOpenLogin}
                  className="px-4 sm:px-5 py-2 rounded-xl text-xs font-bold text-white bg-purple-600 hover:bg-purple-500 shadow-md active:scale-95 transition-all"
                >
      ...
      <section className="relative z-10 pt-12 sm:pt-20 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-950/60 border border-purple-500/30 text-xs text-purple-300 mb-6 shadow-inner animate-fade-in">
        ...
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight leading-[1.2] max-w-4xl mx-auto">
          حيث تلتقي <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-indigo-300 to-teal-300">عراقة الفكر والأدب</span>، بآفاق الذكاء الاصطناعي
        </h1>
        ...
        <p className="mt-5 text-base sm:text-lg lg:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed font-medium">
          منصة أدبية عربية تتيح <span className="text-purple-300 font-bold">للقراء القراءة</span>، و<span className="text-teal-300 font-bold">للكتاب النشر والربح</span>، و<span className="text-cyan-300 font-bold">للمعلنين الإعلان</span>.
        </p>
        ...
        <div className="mt-9 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 max-w-2xl mx-auto">
          {isUserLoggedIn && currentUser ? (
            <button
              onClick={onStartReading}
              className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-700 hover:from-purple-500 hover:to-indigo-500 text-white font-extrabold text-sm sm:text-base shadow-xl shadow-purple-600/30 active:scale-95 transition-all flex items-center justify-center gap-3"
            >
        ...
        <div className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-5 max-w-4xl mx-auto text-center">
          <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md">
            <span className="text-2xl sm:text-3xl font-black text-purple-400">50K+</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div
              className={`${activeFeatureTab === 'readers' ? 'block' : 'hidden md:block'} p-6 sm:p-8 rounded-3xl transition-all border ${
                activeFeatureTab === 'readers'
                  ? 'bg-gradient-to-b from-purple-950/60 to-slate-900 border-purple-500/50 ring-2 ring-purple-500/20 shadow-2xl'
                  : 'bg-slate-900/40 border-slate-800 opacity-90'
              }`}
            >
              <div className="w-12 h-12 rounded-2xl bg-purple-600/20 text-purple-400 border border-purple-500/30 flex items-center justify-center mb-5">
              ...
              <button
                onClick={onStartReading}
                className="mt-6 w-full py-2.5 rounded-xl bg-purple-600/30 hover:bg-purple-600 border border-purple-500/40 text-purple-200 hover:text-white font-bold text-xs transition-all flex items-center justify-center gap-1.5"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {filteredPreviewArticles.map((art) => (
            <div
              ...
              className="group rounded-3xl bg-slate-900/80 border border-slate-800/90 hover:border-purple-500/50 overflow-hidden shadow-lg hover:shadow-purple-500/10 cursor-pointer transition-all duration-300 flex flex-col"
            >
              <div className="relative aspect-16/9 overflow-hidden bg-slate-950">
                ...
                <div className="absolute top-3 start-3">
                  <span className="px-2.5 py-1 rounded-xl bg-slate-950/80 backdrop-blur-md text-[11px] font-bold text-purple-300 border border-purple-500/20">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <img
                      ...
                      alt={art.writerName}
                      referrerPolicy="no-referrer"
                      className="w-6 h-6 rounded-full object-cover ring-1 ring-purple-500/30"
                    />
                    <span className="text-xs font-bold text-slate-300">{art.writerName}</span>
                  </div>
                  <h3 className="font-extrabold text-base text-white group-hover:text-purple-300 transition-colors line-clamp-2">
                    {art.title}
                  </h3>
      ...
      <footer className="mt-20 border-t border-slate-800 bg-slate-950 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto mt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <button onClick={() => onOpenLegal('privacy')} className="hover:text-purple-400 transition-colors font-bold">
              سياسة الخصوصية
            </button>
            <button onClick={() => onOpenLegal('terms')} className="hover:text-purple-400 transition-colors font-bold">
              شروط الاستخدام
            </button>
            <button onClick={() => onOpenLegal('about')} className="hover:text-purple-400 transition-colors font-bold">
              من نحن
            </button>
            <button onClick={() => onOpenLegal('contact')} className="hover:text-purple-400 transition-colors font-bold">
              اتصل بنا
            </button>
          </div>
        </div>
